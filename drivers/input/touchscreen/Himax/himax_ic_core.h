...
#define fw_func_tx_chg_F0_F1_pwd			 0xA55AA55A
#define fw_func_tx_chg_F1_F0_pwd			 0xA33AA33A
#endif
/* CORE_FW */
...
struct himax_core_fp {
	...
	bool (*fp_no_jiter_en)(uint8_t no_jiter_en);
	bool (*fp_edge_limit_en)(uint8_t edge_limit_en);
	//int (*fp_chip_baseline_test)(void);
#endif
	/* CORE_FW */
