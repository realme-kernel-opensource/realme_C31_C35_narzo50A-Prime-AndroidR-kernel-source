...
*****************************************************************************/
static int ft8722_short_test(struct fts_test *tdata, bool *test_result)
{
	int ret = 0;
	int i = 0;
...
static int ft8722_open_test(struct fts_test *tdata, bool *test_result)
{
	int ret = 0;
	int i = 0;
	bool tmp_result = false;
...
static int ft8722_cb_test(struct fts_test *tdata, bool *test_result)
{
	int ret = 0;
	bool tmp_result = false;
	int byte_num = 0;
...
static int ft8722_rawdata_test(struct fts_test *tdata, bool *test_result)
{
	int ret = 0;
	bool tmp_result = false;
	int *rawdata = NULL;
...
static int ft8722_lcdnoise_test(struct fts_test *tdata, bool *test_result)
{
	int ret = 0;
	int i = 0;
	bool tmp_result = false;
...
static int start_test_ft8722(void)
{
	int ret = 0;
	...
	if (true == test_item->short_test) {
		ret = ft8722_short_test(tdata, &temp_result);
	...
	if (true == test_item->open_test) {
		ret = ft8722_open_test(tdata, &temp_result);
	...
	if (true == test_item->cb_test) {
		ret = ft8722_cb_test(tdata, &temp_result);
	...
	if (true == test_item->rawdata_test) {
		ret = ft8722_rawdata_test(tdata, &temp_result);
	...
	if (true == test_item->lcdnoise_test) {
		ret = ft8722_lcdnoise_test(tdata, &temp_result);
...
static int param_init_ft8722(void)
{
...
struct test_funcs test_func_ft8722 = {
	.ctype = {0x20},
	.hwtype = IC_HW_INCELL,
	.key_num_total = 0,
	.param_init = param_init_ft8722,
	.start_test = start_test_ft8722,
};
