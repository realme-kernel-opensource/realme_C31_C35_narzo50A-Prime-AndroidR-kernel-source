...
static int get_test_threshold_incell(void)
{
	...
	if (tdata->func->rawdata2_support) {
		fts_init_buffer(thr->rawdata2_max, thr->basic.rawdata2_max, node_num, false, 0,
				0);
		fts_init_buffer(thr->rawdata2_min, thr->basic.rawdata2_min, node_num, false, 0,
				0);
	}
...
static int get_test_threshold_mc_sc(void)
{
	...
	/* init buffer */
	fts_init_buffer(thr->rawdata_h_min, thr->basic.rawdata_h_min, node_num, false,
			0, 0);
	fts_init_buffer(thr->rawdata_h_max, thr->basic.rawdata_h_max, node_num, false,
			0, 0);

	if (tdata->func->rawdata2_support) {
		fts_init_buffer(thr->rawdata_l_min, thr->basic.rawdata_l_min, node_num, false,
				0, 0);
		fts_init_buffer(thr->rawdata_l_max, thr->basic.rawdata_l_max, node_num, false,
				0, 0);
	}
	...
	fts_init_buffer(thr->scap_cb_off_min, thr->basic.scap_cb_off_min, sc_num, false,
			0, 0);
	fts_init_buffer(thr->scap_cb_off_max, thr->basic.scap_cb_off_max, sc_num, false,
			0, 0);
	fts_init_buffer(thr->scap_cb_on_min, thr->basic.scap_cb_on_min, sc_num, false,
			0, 0);
	fts_init_buffer(thr->scap_cb_on_max, thr->basic.scap_cb_on_max, sc_num, false,
			0, 0);
	fts_init_buffer(thr->scap_cb_hi_min, thr->basic.scap_cb_hi_min, sc_num, false,
			0, 0);
	fts_init_buffer(thr->scap_cb_hi_max, thr->basic.scap_cb_hi_max, sc_num, false,
			0, 0);
	fts_init_buffer(thr->scap_cb_hov_min, thr->basic.scap_cb_hov_min, sc_num, false,
			0, 0);
	fts_init_buffer(thr->scap_cb_hov_max, thr->basic.scap_cb_hov_max, sc_num, false,
			0, 0);
	fts_init_buffer(thr->scap_rawdata_off_min, thr->basic.scap_rawdata_off_min,
			sc_num, false, 0, 0);
	fts_init_buffer(thr->scap_rawdata_off_max, thr->basic.scap_rawdata_off_max,
			sc_num, false, 0, 0);
	fts_init_buffer(thr->scap_rawdata_on_min, thr->basic.scap_rawdata_on_min,
			sc_num, false, 0, 0);
	fts_init_buffer(thr->scap_rawdata_on_max, thr->basic.scap_rawdata_on_max,
			sc_num, false, 0, 0);
	fts_init_buffer(thr->scap_rawdata_hi_min, thr->basic.scap_rawdata_hi_min,
			sc_num, false, 0, 0);
	fts_init_buffer(thr->scap_rawdata_hi_max, thr->basic.scap_rawdata_hi_max,
			sc_num, false, 0, 0);
	fts_init_buffer(thr->scap_rawdata_hov_min, thr->basic.scap_rawdata_hov_min,
			sc_num, false, 0, 0);
	fts_init_buffer(thr->scap_rawdata_hov_max, thr->basic.scap_rawdata_hov_max,
			sc_num, false, 0, 0);
	...
	get_detail_threshold("ScapRawData_ON_Max_", true, thr->scap_rawdata_on_max,
			     sc_num);
	get_detail_threshold("ScapRawData_High_Min_", true, thr->scap_rawdata_hi_min,
			     sc_num);
	get_detail_threshold("ScapRawData_High_Max_", true, thr->scap_rawdata_hi_max,
			     sc_num);
	get_detail_threshold("ScapRawData_Hov_Min_", true, thr->scap_rawdata_hov_min,
			     sc_num);
	get_detail_threshold("ScapRawData_Hov_Max_", true, thr->scap_rawdata_hov_max,
			     sc_num);
...
static void print_thr_mc_sc(void)
{
	...
	print_buffer(thr->scap_cb_on_max, tdata->sc_node.node_num,
		     tdata->sc_node.rx_num);
	print_buffer(thr->scap_cb_hi_min, tdata->sc_node.node_num,
		     tdata->sc_node.rx_num);
	print_buffer(thr->scap_cb_hi_max, tdata->sc_node.node_num,
		     tdata->sc_node.rx_num);
	print_buffer(thr->scap_cb_hov_min, tdata->sc_node.node_num,
		     tdata->sc_node.rx_num);
	print_buffer(thr->scap_cb_hov_max, tdata->sc_node.node_num,
		     tdata->sc_node.rx_num);
	...
	print_buffer(thr->scap_rawdata_on_max, tdata->sc_node.node_num,
		     tdata->sc_node.rx_num);
	print_buffer(thr->scap_rawdata_hi_min, tdata->sc_node.node_num,
		     tdata->sc_node.rx_num);
	print_buffer(thr->scap_rawdata_hi_max, tdata->sc_node.node_num,
		     tdata->sc_node.rx_num);
	print_buffer(thr->scap_rawdata_hov_min, tdata->sc_node.node_num,
		     tdata->sc_node.rx_num);
	print_buffer(thr->scap_rawdata_hov_max, tdata->sc_node.node_num,
		     tdata->sc_node.rx_num);
...
static int get_test_threshold_sc(void)
{
	...
	/* init buffer */
	fts_init_buffer(thr->rawdata_min, thr->basic.rawdata_min, node_num, false, 0,
			0);
	fts_init_buffer(thr->rawdata_max, thr->basic.rawdata_max, node_num, false, 0,
			0);
