...
enum cts_device_fw_reg {
    ...
    CTS_DEVICE_FW_REG_GESTURE_RAWDATA_TARGET = 0x8178,

#ifdef CONFIG_CTS_GESTURE_TEST
	CTS_DEVICE_FW_REG_SCREEN_ON1 = 0xC044,
	CTS_DEVICE_FW_REG_SCREEN_ON2 = 0xC0A4,
	CTS_DEVICE_FW_REG_SCREEN_OFF1 = 0xC0A0,
	CTS_DEVICE_FW_REG_SCREEN_OFF2 = 0xC040,
	CTS_DEVICE_FW_REG_SCREEN = 0xD228,
	...
	CTS_DEVICE_TP_DIRECTION_SWITCH = 0x0801,
};
...
extern void cts_charge_mode_switch(int enable);
extern void cts_headset_mode_switch(int enable);
