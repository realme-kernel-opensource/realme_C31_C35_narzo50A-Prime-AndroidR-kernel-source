...
/*isp sub block:RRGB GTM*/
#define ISP_GTM_GLB_CTRL                        (0x1610UL)
#define ISP_GTM_HIST_CTRL0                      (0x1614UL)
#define ISP_GTM_HIST_CTRL1                      (0x1618UL)
#define ISP_GTM_HIST_YMIN                       (0x161CUL)
#define ISP_GTM_HIST_CTRL2                      (0x1620UL)
#define ISP_GTM_HIST_CTRL3                      (0x1624UL)
#define ISP_GTM_HIST_CTRL4                      (0x1628UL)
#define ISP_GTM_HIST_CTRL5                      (0x162CUL)
#define ISP_GTM_HIST_CTRL6                      (0x1630UL)
#define ISP_GTM_HIST_CTRL7                      (0x1634UL)
#define ISP_GTM_LOG_DIFF                        (0x1638UL)
#define ISP_GTM_TM_YMIN_SMOOTH                  (0x163CUL)
#define ISP_GTM_TM_LUMAFILTER0                  (0x1640UL)
#define ISP_GTM_TM_LUMAFILTER1                  (0x1644UL)
#define ISP_GTM_TM_LUMAFILTER2                  (0x1648UL)
#define ISP_GTM_TM_RGB2TCOEFF0                  (0x164CUL)
#define ISP_GTM_TM_RGB2TCOEFF1                  (0x1650UL)
#define ISP_GTM_HW_YMIN                         (0x1654UL)
#define ISP_GTM_HW_YMAX                         (0x1658UL)
#define ISP_GTM_HW_YAVG                         (0x165CUL)
#define ISP_GTM_HW_TARGET_NORM                  (0x1660UL)
...
#define ISP_YUV_SCALER_BWD_PARA                 (0x0054UL)
/*regular*/
#define ISP_YUV_SCALER_SHRINK_UV                (0x0054UL)
#define ISP_YUV_SCALER_SHRINK_Y                 (0x0058UL)
#define ISP_YUV_SCALER_EFFECT_UV                (0x005CUL)
#define ISP_YUV_SCALER_EFFECT_Y                 (0x0060UL)
#define ISP_YUV_SCALER_REGULAR_CFG              (0x0064UL)
...
#define ISP_YUV_SCALER_VID_CHROMA_VCOEF_BUF0    (0x388F0UL)

#define ISP_YUV_SCALER_VID_LUMA_HCOEF_BUF1      (0x38200UL)
#define ISP_YUV_SCALER_VID_CHROMA_HCOEF_BUF1    (0x38380UL)
#define ISP_YUV_SCALER_VID_LUMA_VCOEF_BUF1      (0x3A4F0UL)
#define ISP_YUV_SCALER_VID_CHROMA_VCOEF_BUF1    (0x3A8F0UL)
...
#define ISP_YUV_SCALER_PRE_CAP_CHROMA_VCOEF_BUF0 (0x398f0UL)

#define ISP_YUV_SCALER_PRE_CAP_LUMA_HCOEF_BUF1   (0x39200UL)
#define ISP_YUV_SCALER_PRE_CAP_CHROMA_HCOEF_BUF1 (0x39380UL)
#define ISP_YUV_SCALER_PRE_CAP_LUMA_VCOEF_BUF1   (0x3B4F0UL)
#define ISP_YUV_SCALER_PRE_CAP_CHROMA_VCOEF_BUF1 (0x3b8f0UL)

/*isp sub block: YUV_SCALER_COEF_HOR*/
#define ISP_YUV_SCALER1_COEF_ADDR1              (0xc400UL)
#define ISP_YUV_SCALER1_COEF1_ADDR1             (0xc500UL)
#define ISP_YUV_SCALER1_COEF2_ADDR1             (0xc600UL)
#define ISP_YUV_SCALER1_COEF3_ADDR1             (0xc700UL)

#define ISP_YUV_SCALER2_COEF_ADDR2              (0xd400UL)
#define ISP_YUV_SCALER2_COEF1_ADDR2             (0xd500UL)
#define ISP_YUV_SCALER2_COEF2_ADDR2             (0xd600UL)
#define ISP_YUV_SCALER2_COEF3_ADDR2             (0xd700UL)
/*SCL_CAP*/
#define ISP_CAP_PATH_HOR_CORF_Y                 (0x10)
#define ISP_CAP_PATH_HOR_CORF_UV                (0x90)
/*SCL_VID*/
#define ISP_VID_PATH_HOR_CORF_Y                 (0x10)
#define ISP_VID_PATH_HOR_CORF_UV                (0x90)
