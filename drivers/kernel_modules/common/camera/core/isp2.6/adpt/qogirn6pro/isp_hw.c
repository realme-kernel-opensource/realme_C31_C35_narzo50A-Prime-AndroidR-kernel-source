...
isp_hw_para:
	...
	ISP_HREG_MWR(ISP_ARBITER_WR_PARAM2, 0xFFFF, 0xFF08);
	ISP_HREG_MWR(ISP_ARBITER_WR_PARAM4, 0xFFFF, 0x0010);
	ISP_HREG_MWR(ISP_ARBITER_WR_PARAM5, 0xFFFFFFF, 0x0100F10);
	ISP_HREG_MWR(ISP_ARBITER_WR_PARAM6, 0xFFFF, 0x0010);
	ISP_HREG_MWR(ISP_ARBITER_WR_PARAM7, 0xFFFFFFF, 0x0100000);
