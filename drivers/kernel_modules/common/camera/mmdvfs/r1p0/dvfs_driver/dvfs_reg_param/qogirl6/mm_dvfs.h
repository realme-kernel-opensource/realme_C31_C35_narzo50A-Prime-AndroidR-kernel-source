...
enum {
	DCAM_CLK480   = 48000000, //48
	DCAM_CLK640   = 64000000, //64
	DCAM_CLK768  = 76800000, //spec78.6???
	DCAM_CLK1920 = 192000000, //384
	DCAM_CLK2560 = 256000000, //468
	DCAM_CLK3072 = 307200000, //307.2
	DCAM_CLK3840 = 384000000, //384
	DCAM_CLK4680 = 468000000, //468
};

enum {
	DCAMAXI_CLK2560 = 256000000, //256
	DCAMAXI_CLK3072 = 307200000, //307.2
	DCAMAXI_CLK3840 = 384000000, //384
	DCAMAXI_CLK4680 = 468000000, //468
};
...
enum {
	...
	DCAM_CLK_INDEX_2560 = 1, //256
	DCAM_CLK_INDEX_3072 = 2, //307.2
	DCAM_CLK_INDEX_3840 = 3, //384
	DCAM_CLK_INDEX_4680 = 4, //468
};

enum {
	DCAMAXI_CLK_INDEX_2560 = 0, //256
	DCAMAXI_CLK_INDEX_3072 = 1, //307.2
	DCAMAXI_CLK_INDEX_3840 = 2, //384
	DCAMAXI_CLK_INDEX_4680 = 3, //468
};
