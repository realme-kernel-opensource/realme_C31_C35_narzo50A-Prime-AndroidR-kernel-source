...
struct ip_dvfs_map_cfg  cpp_dvfs_config_table[8] = {
	...
	{6, REG_MM_DVFS_AHB_CPP_INDEX6_MAP, VOLT75, CPP_CLK3840,
		CPP_CLK_INDEX_3840, 0, 0, 0, MTX_CLK_INDEX_4680, "0.75v"},
	{7, REG_MM_DVFS_AHB_CPP_INDEX7_MAP, VOLT75, CPP_CLK3840,
		CPP_CLK_INDEX_3840, 0, 0, 0, MTX_CLK_INDEX_4680, "0.75v"},
};
...
struct ip_dvfs_map_cfg dcamaxi_dvfs_config_table[] = {
	...
	{2, REG_MM_DVFS_AHB_DCAM_AXI_INDEX2_MAP, VOLT70,
		DCAMAXI_CLK3840, DCAMAXI_CLK_INDEX_3840, 0, 0, 0, 0, "0.7v"},
	{3, REG_MM_DVFS_AHB_DCAM_AXI_INDEX3_MAP, VOLT75,
		DCAMAXI_CLK4680, DCAMAXI_CLK_INDEX_4680, 0, 0, 0, 0, "0.75v"},
	{4, REG_MM_DVFS_AHB_DCAM_AXI_INDEX4_MAP, VOLT75,
		DCAMAXI_CLK4680, DCAMAXI_CLK_INDEX_4680, 0, 0, 0, 0, "0.75v"},
	{5, REG_MM_DVFS_AHB_DCAM_AXI_INDEX5_MAP, VOLT75,
		DCAMAXI_CLK4680, DCAMAXI_CLK_INDEX_4680, 0, 0, 0, 0, "0.75v"},
	{6, REG_MM_DVFS_AHB_DCAM_AXI_INDEX6_MAP, VOLT75,
		DCAMAXI_CLK4680, DCAMAXI_CLK_INDEX_4680, 0, 0, 0, 0, "0.75v"},
	{7, REG_MM_DVFS_AHB_DCAM_AXI_INDEX7_MAP, VOLT75,
		DCAMAXI_CLK4680, DCAMAXI_CLK_INDEX_4680, 0, 0, 0, 0, "0.75v"},
};
...
struct ip_dvfs_map_cfg dcam_dvfs_config_table[8] = {
	...
	{6, REG_MM_DVFS_AHB_DCAM_IF_INDEX6_MAP,
		VOLT70, DCAM_CLK3840, DCAM_CLK_INDEX_3840,
		0, 0, DCAMAXI_CLK_INDEX_3840, 0, "0.7v"},
...
struct ip_dvfs_map_cfg jpg_dvfs_config_table[8] = {
	...
	{6, REG_MM_DVFS_AHB_JPG_INDEX6_MAP, VOLT75,
		JPG_CLK3840, JPG_CLK_INDEX_3840, 0, 0, 0, MTX_CLK_INDEX_4680, "0.75v"},
