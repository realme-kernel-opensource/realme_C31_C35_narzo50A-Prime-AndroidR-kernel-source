...
static const struct smtc_reg_data sx933x_i2c_reg_setup[] =
{
    //
    {
        .reg = SX933X_AFECTRL_REG, //4054
        .val = 0x00000400,
    },
    //
    {
        .reg = SX933X_PWM_REG, //4080
        .val = 0x80804000,
    },
    {
        .reg = SX933X_CLKGEN_REG, //4200
        .val = 0x00000008,
    },
    //
    {
        .reg = SX933X_PINCFG_REG, //42c0
        .val = 0x08000000,
    },
    {
    ...
    //
    {
        .reg = SX933X_IRQCFG0_REG, //800c
        .val = 0x00000000,
    },
    {
        .reg = SX933X_IRQCFG1_REG, //8010
        .val = 0x00000000,
    },
    {
        .reg = SX933X_IRQCFG2_REG, //8014
        .val = 0x00000000,
    },
    {
        .reg = SX933X_IRQCFG3_REG, //8018
        .val = 0x00000000,
    },
    //
    {
    ...
    {
        .reg = SX933X_GNRLCTRL2_REG, //8020
        .val = 10001,//enanle phase0-phase4
    },
    {
    ...
    {
        .reg = SX933X_ADVDIG0PH0_REG, //8060
        .val = 0x00000000,
    },
    {
    ...
    {
        .reg = SX933X_ADVDIG3PH0_REG, //806c
        .val = 0x00000000,
    },
    {
    ...
    {
        .reg = SX933X_ADVDIG0PH1_REG,//8080
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG1PH1_REG,//8084
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG2PH1_REG,//8088
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG3PH1_REG,//808c
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG4PH1_REG,//8090
        .val = 0x00000000,
    },
    {
    ...
    {
        .reg = SX933X_ADVDIG0PH2_REG,//80a0
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG1PH2_REG,//80a4
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG2PH2_REG,//80a8
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG3PH2_REG,//80ac
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG4PH2_REG,//80b0
        .val = 0x00000000,
    },
    {
    ...
    {
        .reg = SX933X_AVGBFILTPH3_REG,//80b8
        .val = 0x20600C00,
    },
    {
        .reg = SX933X_AVGAFILTPH3_REG,//80bc
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG0PH3_REG,//80c0
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG1PH3_REG,//80c4
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG2PH3_REG,//80c8
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG3PH3_REG,//80cc
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG4PH3_REG,//80d0
        .val = 0x00000000,
    },
    {
    ...
    {
        .reg = SX933X_AVGBFILTPH4_REG,//80d8
        .val = 0x20600C00,
    },
    {
        .reg = SX933X_AVGAFILTPH4_REG,//80dc
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG0PH4_REG,//80e0
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG1PH4_REG,//80e4
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG2PH4_REG,//80e8
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG3PH4_REG,//80ec
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG4PH4_REG,//80f0
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADCFILTPH5_REG,//80f4
        .val = 0x100000,
    },
    {
        .reg = SX933X_AVGBFILTPH5_REG,//80f8
        .val = 0x20600C00,
    },
    {
        .reg = SX933X_AVGAFILTPH5_REG,//80fc
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG0PH5_REG,//8100
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG1PH5_REG,//8104
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG2PH5_REG,//8108
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG3PH5_REG ,//810c
        .val = 0x00000000,
    },
    {
        .reg = SX933X_ADVDIG4PH5_REG,//8110
        .val = 0x00000000,
    },
    /*
    {
        .reg = SX933X_STEPCANCEL0A_REG,//8114
        .val = 0x00000000,
    },
    {
        .reg = SX933X_STEPCANCEL1A_REG,//8118
        .val = 0x00000000,
    },
    {
        .reg = SX933X_STEPCANCEL0B_REG,//811c
        .val = 0x00000000,
    },
    {
        .reg = SX933X_STEPCANCEL1B_REG,//8120
        .val = 0x00000000,
    },
    */
    {
        .reg = SX933X_REFCORRA_REG,//8124
        .val = 0x04000003,
    },
    {
        .reg = SX933X_REFCORRB_REG,//8128
        .val = 0x4000004,
    },
    {
        .reg = SX933X_SMARTSAR0A_REG,//812c
        .val = 0x00000000,
    },
    {
        .reg = SX933X_SMARTSAR1A_REG,//8130
        .val = 0x00000000,
    },
    {
        .reg = SX933X_SMARTSAR2A_REG,//8134
        .val = 0x00000000,
    },
    {
    ...
    {
        .reg = SX933X_SMARTSAR1B_REG,//813c
        .val = 0x00000000,
    },
    {
        .reg = SX933X_SMARTSAR2B_REG,//8140
        .val = 0x00000000,
    },
   /*
    {
        .reg = SX933X_PROX2PWMA_REG,//8150
        .val = 0x00000000,
    },
    {
        .reg = SX933X_AUTOFREQ0_REG,//8154
        .val = 0x00000000,
    },
    {
        .reg = SX933X_AUTOFREQ1_REG,//8158
        .val = 0x00000000,
    },
   */
    {
        .reg = SX933X_HOSTIRQMSK_REG,//4004
        .val = 0x00000070,
    },
    {
        .reg = SX933X_HOSTIRQCTRL_REG,//4008
        .val = 0x00,
    }
};
