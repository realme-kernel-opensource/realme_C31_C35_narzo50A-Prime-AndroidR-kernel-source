...
#define EVENT_DOWN(flag)	((flag == FTS_TOUCH_DOWN) || \
				 (flag == FTS_TOUCH_CONTACT))
...
struct fts8756_ts_resume {
	struct kthread_worker resume_kworker;
	struct kthread_work resume_kwork;
