...
#define SPRDWL_CAPA_SCAN_RANDOM_MAC_ADDR		BIT(12)
#define SPRDWL_CAPA_SCHED_SCAN_RANDOM_MAC_ADDR		BIT(13)
	__le32 fw_capa;
	u8 max_ap_assoc_sta;
...
#define SPRDWL_FLAGS_SCAN_RANDOM_ADDR	BIT(0)
	__le32 flags;
	u16 ssid_len;
	u8 param[0];
} __packed;
