...
#define SPRDWL_CIPHER_GCMP_256		9
...
enum SPRDWL_ACTION_NPI_SEND_RECEIVE {
	SPRDWL_ACTION_SET_AR_FOR_WMM,
	SPRDWL_ACTION_RESET_AR_FOR_WMM,
};
...
struct sprdwl_cmd_sched_scan_ifrc {
	...
	u32 flags;
	s32 rssi_thold;
	u8 chan[TOTAL_2G_5G_CHANNEL_NUM];
} __packed;
