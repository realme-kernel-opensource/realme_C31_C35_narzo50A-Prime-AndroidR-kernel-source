...
#define SPRDWL_PCIE_RX_ALLOC_BUF 19
#define SPRDWL_PCIE_RX_FLUSH_BUF 20
#define SPRDWL_PCIE_TX_MOVE_BUF 21
#define SPRDWL_PCIE_TX_FREE_BUF 22
#ifdef ENABLE_PAM_WIFI
#define SPRDWL_WORK_UL_RES_STS_CMD 23
#endif
...
struct sprdwl_npi_send_receive_info {
	u8 s_buf[NPI_LEN_MAX];
	u16 s_len;
	u8 r_buf[NPI_LEN_MAX];
	u16 r_len;
};
