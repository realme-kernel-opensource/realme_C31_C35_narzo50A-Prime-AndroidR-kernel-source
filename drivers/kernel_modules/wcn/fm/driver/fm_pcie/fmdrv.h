...
struct rds_group_cnt {
    unsigned long total;
    /* RDS groupA counter */
    unsigned long groupA[16];
    /* RDS groupB counter */
    unsigned long groupB[16];
};
#endif
...
struct fm_rds_handle {
    ...
    unsigned long rds_parse_start_time;
    unsigned long rds_parse_stop_time;
	/* get RT count */
...
#define FM_IOCTL_COMPAT_STOP_SCAN		0x8f509
...
/*Frequency offset, PDP_TH,PHP_TH, SNR_TH,RSS_THI*/
#define FM_IOCTL_SET_SEEK_CRITERIA       _IOWR(FM_IOC_MAGIC, 0x4F, struct fm_seek_criteria_parm*)
/*softmute ,blending ,snr_th*/
#define FM_IOCTL_SET_AUDIO_THRESHOLD _IOWR(FM_IOC_MAGIC, 0x50, struct fm_audio_threshold_parm*)
/*Frequency offset, PDP_TH,PHP_TH, SNR_TH,RSS_THI*/
#define FM_IOCTL_GET_SEEK_CRITERIA       _IOWR(FM_IOC_MAGIC, 0x51, struct fm_seek_criteria_parm*)
/*softmute ,blending ,snr_th*/
#define FM_IOCTL_GET_AUDIO_THRESHOLD _IOWR(FM_IOC_MAGIC, 0x52, struct fm_audio_threshold_parm*)
...
/* IOCTL for EM */
#define FM_IOCTL_FULL_CQI_LOG _IOWR(FM_IOC_MAGIC, 70, struct fm_full_cqi_log_t *)
