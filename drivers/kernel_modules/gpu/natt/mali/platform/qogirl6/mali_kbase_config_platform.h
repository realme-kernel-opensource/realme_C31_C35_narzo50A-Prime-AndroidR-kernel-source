 ...
 */
#define POWER_MANAGEMENT_CALLBACKS (&pm_qogirl6_callbacks)
 ...
 */
#define PLATFORM_FUNCS (&platform_qogirl6_funcs)
...
extern struct kbase_pm_callback_conf pm_qogirl6_callbacks;
extern struct kbase_platform_funcs_conf platform_qogirl6_funcs;
