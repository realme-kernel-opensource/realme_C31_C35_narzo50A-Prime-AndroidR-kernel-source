...
void kbase_debug_dump_registers(struct kbase_device *kbdev)
{
	...
	dev_err(kbdev->dev,"   GPU_IRQ_STATUS=0x%08x GPU_FAULTSTATUS=0x%08x",
		kbase_reg_read(kbdev, GPU_CONTROL_REG(GPU_IRQ_STATUS)),
		kbase_reg_read(kbdev, GPU_CONTROL_REG(GPU_FAULTSTATUS)));
	dev_err(kbdev->dev,"   GPU_FAULTADDRESS_HI=0x%08x  GPU_FAULTADDRESS_LO=0x%08x",
		kbase_reg_read(kbdev, GPU_CONTROL_REG(GPU_FAULTADDRESS_HI)),
		kbase_reg_read(kbdev, GPU_CONTROL_REG(GPU_FAULTADDRESS_LO)));
	...
	dev_err(kbdev->dev, "  JOB_IRQ_STATUS=0x%08x ",
	...
	dev_err(kbdev->dev, "  MMU_IRQ_RAWSTAT=0x%08x MMU_IRQ_STATUS=0x%08x",
		kbase_reg_read(kbdev, MMU_REG(MMU_IRQ_RAWSTAT)),
		kbase_reg_read(kbdev, GPU_CONTROL_REG(MMU_IRQ_STATUS)));
