...
/**
 * struct kbase_uk_set_boost - User/Kernel space data exchange structure
 * @header:     UK structure header
 * @level:   the level of the thread
 *
 * This structure is used when set boost level.
 */
...
#define KBASE_IOCTL_SET_BOOST \
	_IOW(KBASE_IOCTL_TYPE, 36, struct kbase_ioctl_set_boost)
